...
class ClassificationEngine:
    ...
    def classify_fields(self, source, object_name, fields, name_key="name", type_key="type",
        ...
        # Accept both kwarg spellings: the connectors call this with
        # field_name_key/field_type_key; name_key/type_key remain supported.
        if field_name_key is not None: name_key = field_name_key
        if field_type_key is not None: type_key = field_type_key
        results = {}
        for f in fields:
